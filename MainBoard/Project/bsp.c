...
void GPIO_Configure(void)
{
	...
	/******************system configure*******************/
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_2 | GPIO_Pin_6;//LED
	...
	/* Connect EXTI11 Line to PA.15 pin */
	...
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = EXTI15_10_PRIORITY;
	NVIC_InitStructure.NVIC_IRQChannelSubPriority = 0;
	NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
	NVIC_Init(&NVIC_InitStructure);
...
// 	mMaininf.mSystem.mSystem10usTick = 0;
	...
	mMaininf.mSystem.mGuideTimeOutTime = 0;
	...
	mMaininf.mWork.mWorkInitCont = 0;
