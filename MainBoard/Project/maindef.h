...
typedef enum
{
	TEST_DC5V = 0x01,                        //01检测DC5V
	TEST_DC15V,                              //02检测DC15V
	TEST_IP_A,                               //03检测引导A
	TEST_IP_B,                               //04检测引导B
	TEST_IP_TOP,                             //05检测引导C
	TEST_IP_N,                               //06检测
...
typedef struct{
	...
	u8 mSignalBCountDownFlag : 1;
	u16 mSignalBCountDownTime;
	u8 mSignalCCountDownFlag : 1;
	u16 mSignalCCountDownTime;
} _SENSORGUIDE;
