...
void api_Receive_Guide(u8 Flag);
void api_Clear_Guide_Receive_Flag(void);
...
void api_GetAnalyzeGuideSignal(enum_GUIDE eGuide)
{
	...
	if(mMaininf.mWork.mGuideReceive[eGuide].mGuideNewReceiveStartFlag == 1)
	{
		...
		{
			if(api_GetAnalyzePeriod(mMaininf.mWork.mGuideReceive[eGuide].mTimePeriod,17,28) == 1)
			{
				//查找到头信号
				mMaininf.mWork.mGuideReceive[eGuide].mGuideStartDecodeFlag = 1;
				mMaininf.mSystem.mGuideTimeOutTime = api_GetCurrentSystemTime();
			}
			else
			{
		...
		{
			if(api_GetSystemTimePeriod(mMaininf.mSystem.mGuideTimeOutTime) < 4)
			{
				//mMaininf.mWork.mGuideReceive[eGuide].mDecodeIndex ++;
				
				if(api_GetAnalyzePeriod(mMaininf.mWork.mGuideReceive[eGuide].mTimePeriod,2,5) == 1)//1.12ms     0
				{
					mMaininf.mWork.mGuideReceive[eGuide].mDecodeIndex ++;
					mMaininf.mSystem.mGuideTimeOutTime = api_GetCurrentSystemTime();
					mMaininf.mWork.mGuideReceive[eGuide].mDecodeData = mMaininf.mWork.mGuideReceive[eGuide].mDecodeData << 1;
				}
				else if(api_GetAnalyzePeriod(mMaininf.mWork.mGuideReceive[eGuide].mTimePeriod,6,11) == 1)//2.25ms    1
				{
					mMaininf.mWork.mGuideReceive[eGuide].mDecodeIndex ++;
					mMaininf.mSystem.mGuideTimeOutTime = api_GetCurrentSystemTime();
...
// 				}
			...
			if(mMaininf.mWork.mGuideReceive[eGuide].mDecodeIndex >= 8)
			{
				...
				if((mMaininf.mWork.mGuideReceive[eGuide].mDecodeRecData == ENUM_GUIDE_A) || 
					(mMaininf.mWork.mGuideReceive[eGuide].mDecodeRecData == ENUM_GUIDE_B) || 
					(mMaininf.mWork.mGuideReceive[eGuide].mDecodeRecData == ENUM_GUIDE_C))
				{
...
void api_JudgeGuideSignal(enum_GUIDE eGuide)
{
	...
	if(mMaininf.mWork.mGuideReceive[eGuide].mDecodeRecData == ENUM_GUIDE_B)
	{
		mMaininf.mWork.mGuideReceive[eGuide].mSignalBCountDownFlag = 1;
		mMaininf.mWork.mGuideReceive[eGuide].mSignalBCountDownTime = 500;
	}
	if(mMaininf.mWork.mGuideReceive[eGuide].mDecodeRecData == ENUM_GUIDE_C)
	{
		mMaininf.mWork.mGuideReceive[eGuide].mSignalCCountDownFlag = 1;
		mMaininf.mWork.mGuideReceive[eGuide].mSignalCCountDownTime = 500;
	}
}

/*****************************************************************************
 * @name       :u8 api_GetGuideAFlag(enum_GUIDE eGuide)
 * @date       :2020-09-19 
 * @author     :zhengbaiqiu 
 * @function   :判断信号状态
 * @parameters :相应
...
u8 api_GetGuideFlag(enum_GUIDE eGuide)
{
	...
	if(mMaininf.mWork.mGuideReceive[eGuide].mSignalACountDownFlag == 1)
	{
		sta = sta | 0x01;
	}
	if(mMaininf.mWork.mGuideReceive[eGuide].mSignalBCountDownFlag == 1)
	{
		sta = sta | 0x02;
	}
	if(mMaininf.mWork.mGuideReceive[eGuide].mSignalCCountDownFlag == 1)
	{
		sta = sta | 0x04;
	}
...
/*****************************************************************************
 * @name       :void api_Receive_Guide(u8 Flag)
 * @date       :2020-09-19 
 * @author     :zhengbaiqiu 
 * @function   :判断信号状态
 * @parameters :相应
...
/*****************************************************************************
 * @name       :void api_Clear_Guide_Receive_Flag(void)
 * @date       :2020-09-19 
 * @author     :zhengbaiqiu 
 * @function   :判断信号状态
 * @parameters :相应
...
void api_Clear_Guide_Receive_Flag(void)
{
	memset(&mMaininf.mWork.mGuideReceive[0], 0, sizeof(mMaininf.mWork.mGuideReceive[0]));
	memset(&mMaininf.mWork.mGuideReceive[1], 0, sizeof(mMaininf.mWork.mGuideReceive[1]));
	memset(&mMaininf.mWork.mGuideReceive[2], 0, sizeof(mMaininf.mWork.mGuideReceive[2]));
	memset(&mMaininf.mWork.mGuideReceive[3], 0, sizeof(mMaininf.mWork.mGuideReceive[3]));
	memset(&mMaininf.mWork.mGuideReceive[4], 0, sizeof(mMaininf.mWork.mGuideReceive[4]));
}
